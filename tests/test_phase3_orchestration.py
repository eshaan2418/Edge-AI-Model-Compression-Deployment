...
from edge_ai_compression.experiments.run_phase3 import run
...
def test_phase3_smoke_trains_then_runs_ladder_and_merges(tmp_path):
    results, models = tmp_path / "results", tmp_path / "models"
    run("resnet18", [0], "cpu", results, models, smoke=True, skip_train=False)
